...
10. `requirements.txt` - набор зависимостей для сборки Docker-образа. 
...
Для проверки качества этой разметки (и не только этой разметки, но и окончательного варианта разметки и точности обучаемых моделей в целом) был собран валидационный набор данных, состоящий из изображений, на которых присутствуют:
...
Классы выбирались на основе тех типов логотипов, которые модель чаще всего принимала за логотип Т-Банка. Логотипы в собранной обучающей выборке выглядят следующим образом: 
